const en = {
  translation: {
    ...
    login: {
      title: 'Welcome Back',
      subtitle: 'Sign in to continue using EV Charging',
      ...
      phoneTitle: 'Login with phone number',
      phoneSubtitle: 'Enter the phone number registered with your account. We will send you a one-time password.',
      ...
      otpRequestFailed: 'Unable to send OTP. Please try again.',
      phoneLoginFailed: 'Unable to verify OTP. Please try again.',
      ...
      register: 'Register',
      footer: 'EV Charging Platform',
    },
    forgotPassword: {
      title: 'Reset password',
      subtitle: 'Enter your registered email address. We will send you instructions to reset your password.',
      emailPlaceholder: 'Enter your email address',
      emailInvalid: 'Please enter a valid email address.',
      sendLink: 'Send reset link',
      sentTitle: 'Check your email',
      sentMessage: 'Password reset instructions have been sent to your email address.',
    ...
    station: {
      ...
      charging: 'Charging',
      chargingCount: '{{count}} charging',
      chargingWithPercentage: 'Charging {{percentage}}%',
      noAvailableConnector: 'No connector available',
