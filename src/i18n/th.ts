const th = {
  translation: {
    ...
    login: {
      ...
      subtitle: 'เข้าสู่ระบบเพื่อใช้งาน EV Charging ต่อ',
      identifier: 'ชื่อผู้ใช้ / อีเมล',
      identifierPlaceholder: 'กรอกชื่อผู้ใช้หรืออีเมล',
      identifierRequired: 'กรุณากรอกชื่อผู้ใช้หรืออีเมล',
      password: 'รหัสผ่าน',
      ...
      failed: 'เข้าสู่ระบบไม่สำเร็จ กรุณาตรวจสอบชื่อผู้ใช้และรหัสผ่าน',
      or: 'หรือ',
      google: 'ดำเนินการต่อด้วย Google',
      googleFailed: 'ไม่สามารถเข้าสู่ระบบด้วย Google ได้ กรุณาลองใหม่',
      phone: 'เข้าสู่ระบบด้วยเบอร์โทรศัพท์',
      phoneTitle: 'เข้าสู่ระบบด้วยเบอร์โทรศัพท์',
      phoneSubtitle: 'กรอกเบอร์โทรศัพท์ที่ลงทะเบียนไว้ ระบบจะส่งรหัส OTP ให้คุณ',
      phonePlaceholder: 'กรอกเบอร์โทรศัพท์',
      phoneInvalid: 'กรุณากรอกเบอร์โทรศัพท์ให้ถูกต้อง',
      sendOtp: 'ส่งรหัส OTP',
      otpTitle: 'กรอกรหัสยืนยัน',
      otpSubtitle: 'กรอกรหัส 6 หลักที่ส่งไปยังเบอร์โทรศัพท์ของคุณ',
      otpInvalid: 'กรุณากรอกรหัสยืนยัน 6 หลัก',
      otpRequestFailed: 'ไม่สามารถส่งรหัส OTP ได้ กรุณาลองใหม่',
      phoneLoginFailed: 'ไม่สามารถยืนยันรหัส OTP ได้ กรุณาลองใหม่',
      verifyAndLogin: 'ยืนยันและเข้าสู่ระบบ',
      resendOtp: 'ส่งรหัส OTP อีกครั้ง',
      changePhone: 'เปลี่ยนเบอร์โทรศัพท์',
      reference: 'เลขอ้างอิง: {{value}}',
      noAccount: 'ยังไม่มีบัญชีผู้ใช้?',
      register: 'สมัครสมาชิก',
      footer: 'แพลตฟอร์ม EV Charging',
    },
    forgotPassword: {
      title: 'ตั้งรหัสผ่านใหม่',
      subtitle: 'กรอกอีเมลที่ลงทะเบียนไว้ เราจะส่งวิธีตั้งรหัสผ่านใหม่ไปให้',
      emailPlaceholder: 'กรอกอีเมลของคุณ',
      emailInvalid: 'กรุณากรอกอีเมลให้ถูกต้อง',
      sendLink: 'ส่งลิงก์ตั้งรหัสผ่านใหม่',
      sentTitle: 'ตรวจสอบอีเมลของคุณ',
      sentMessage: 'เราได้ส่งวิธีตั้งรหัสผ่านใหม่ไปยังอีเมลของคุณแล้ว',
      requestFailed: 'ไม่สามารถส่งวิธีตั้งรหัสผ่านใหม่ได้ กรุณาลองใหม่',
    },
    register: {
    ...
    station: {
      ...
      charging: 'กำลังชาร์จ',
      chargingCount: 'กำลังชาร์จ {{count}} หัว',
      chargingWithPercentage: 'กำลังชาร์จ {{percentage}}%',
      noAvailableConnector: 'ไม่มีหัวชาร์จว่าง',
