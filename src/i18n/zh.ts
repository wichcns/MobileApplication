const zh = {
  translation: {
    ...
    login: {
      title: '欢迎回来',
      subtitle: '登录以继续使用 EV Charging',
      identifier: '用户名 / 电子邮箱',
      identifierPlaceholder: '输入用户名或电子邮箱',
      identifierRequired: '请输入用户名或电子邮箱。',
      password: '密码',
      ...
      phone: '使用手机号登录',
      phoneTitle: '使用手机号登录',
      phoneSubtitle: '输入与账户关联的手机号码，我们会发送一次性验证码。',
      phonePlaceholder: '输入手机号码',
      phoneInvalid: '请输入有效的手机号码。',
      sendOtp: '发送验证码',
      otpTitle: '输入验证码',
      otpSubtitle: '请输入发送到您手机的 6 位验证码。',
      otpInvalid: '请输入 6 位验证码。',
      otpRequestFailed: '无法发送验证码，请重试。',
      phoneLoginFailed: '无法验证验证码，请重试。',
      verifyAndLogin: '验证并登录',
      resendOtp: '重新发送验证码',
      changePhone: '更换手机号码',
      reference: '参考编号：{{value}}',
      noAccount: '还没有账户？',
      register: '注册',
      footer: 'EV Charging 平台',
    },
    forgotPassword: {
      title: '重置密码',
      subtitle: '请输入已注册的电子邮箱，我们会向您发送重置密码的说明。',
      emailPlaceholder: '输入您的电子邮箱',
      emailInvalid: '请输入有效的电子邮箱。',
      sendLink: '发送重置链接',
      sentTitle: '请查看您的电子邮箱',
      sentMessage: '重置密码说明已发送到您的电子邮箱。',
      requestFailed: '无法发送重置密码说明，请重试。',
    },
    register: {
      title: '创建账户',
    ...
    station: {
      ...
      unavailable: '不可用',
      charging: '正在充电',
      chargingCount: '正在充电 {{count}} 个',
      chargingWithPercentage: '正在充电 {{percentage}}%',
      noAvailableConnector: '暂无可用充电接口',
